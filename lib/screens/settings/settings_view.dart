...
class SettingsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final email = auth.account ?? user?.email;
    ...
    return ListView(
      ...
      children: [
        ...
        ListTile(
          ...
          title: Text(
            isSignedIn ? l.accountStatusSignedIn : l.accountStatusSignedOut,
          ),
          subtitle: Text(
            isSignedIn ? (email ?? l.accountNoInfo) : l.accountBackToLogin,
          ),
          trailing: TextButton(
